    ...
    process: [
      {
        ...
        images: [
          { src: '/assets/image/projects/atibox/artibox_logo.png', alt: 'Logo Artibox' },
        ],
      },
      {
      ...
      },
      {
        ...
        images: [
          { src: '/assets/image/projects/atibox/Artiboxx_homepage.png', alt: 'Page d\'accueil desktop' },
          { src: '/assets/image/projects/atibox/Atibox_hompage_phone.png', alt: 'Page d\'accueil mobile' },
          { src: '/assets/image/projects/atibox/Bageguide_page.png', alt: 'Page guide' },
        ],
      },
      {
        ...
        images: [
          { src: '/assets/image/projects/atibox/user_profile_pc.png', alt: 'Profil utilisateur desktop' },
          { src: '/assets/image/projects/atibox/User_profile_phone.png', alt: 'Profil utilisateur mobile' },
        ],
      },
    ],
  },
    ...
    process: [
      {
        ...
        images: [
          { src: '/assets/image/projects/gnew/Gnews_HomePage.png', alt: 'Page d\'accueil Gnews' },
          { src: '/assets/image/projects/gnew/Gnews_Subcribe_to_news.png', alt: 'Page d\'abonnement aux actualités' },
        ],
      },
      {
      ...
      },
      {
        ...
        images: [
          { src: '/assets/image/projects/gnew/diagrame_architecture.png', alt: 'Diagramme d\'architecture' },
        ],
      },
      {
  ...
  },
  {
    ...
    process: [
      ...
      },
      {
        ...
        images: [
          { src: '/assets/image/projects/veux-tu-mepuser/Scene_1.png', alt: 'Scène 1' },
          { src: '/assets/image/projects/veux-tu-mepuser/Scene_2.png', alt: 'Scène 2' },
        ],
      },
      {
        ...
        sections: [
          {
            ...
            image: { src: '/assets/image/projects/modelisation-3d/Luca_3D%20Reference%20sheet.png', alt: 'Fiche de référence 3D' },
          },
          {
            title: 'Modélisation',
            ...
            image: { src: '/assets/image/projects/modelisation-3d/image(5).png', alt: 'Rendu final du modèle' },
          },
          {
            ...
            image: { src: '/assets/image/projects/modelisation-3d/Luca_bones.png', alt: 'Rigging — Bones' },
          },
          {
            ...
            image: { src: '/assets/image/projects/modelisation-3d/luca_keyframe_animation.png', alt: 'Animation keyframe' },
          },
          {
            ...
            image: { src: '/assets/image/projects/modelisation-3d/luca_scens.png', alt: 'Scènes finales' },
          },
        ],
      },
      {
        ...
        images: [
          { src: '/assets/image/projects/modelisation-3d/bureaux%20animation.png', alt: 'Animation bureau' },
        ],
      },
      {
        ...
        tools: ['Blender'],
        images: [
          { src: '/assets/image/projects/modelisation-3d/medelin_bouteilleg.png', alt: 'Modélisation bouteille' },
          { src: '/assets/image/projects/modelisation-3d/Modeling_lustre_ampoule.png', alt: 'Modélisation lustre' },
        ],
      },
      {
        ...
        sections: [
          {
            ...
            image: { src: '/assets/image/projects/modelisation-3d/pelush_seamUV.png', alt: 'Dépliage UV de la peluche' },
          },
          {
            ...
            image: { src: '/assets/image/projects/modelisation-3d/plush_subtancepainter.png', alt: 'Texturage dans Substance Painter' },
          },
          {
            ...
            image: { src: '/assets/image/projects/modelisation-3d/pelush_unitySDK.png', alt: 'Peluche intégrée dans Unity' },
          },
          {
            ...
            image: { src: '/assets/image/projects/modelisation-3d/Peluch_map.png', alt: 'Peluche dans la map du jeu' },
          },
        ],
      },
    ],
    ...
    process: [
      {
        ...
        images: [
          { src: '/assets/image/projects/astral-sword/Diagram.png', alt: 'Diagramme du système' },
        ],
      },
      {
        ...
        images: [
          { src: '/assets/image/projects/astral-sword/Fontview_Interactif_device_Max_MSP.png', alt: 'Dispositif Max MSP' },
          { src: '/assets/image/projects/astral-sword/Max_masp_SwordSwing.png', alt: 'Patch Max MSP — Sword Swing' },
        ],
      },
      {
        ...
        images: [
          { src: '/assets/image/projects/astral-sword/Fronview_interactif_device.png', alt: 'Vue de face du dispositif' },
          { src: '/assets/image/projects/astral-sword/acceleometer_sword.png', alt: 'Accéléromètre épée' },
      ...
      },
      {
        ...
        images: [
          { src: '/assets/image/projects/astral-sword/End_resultt.png', alt: 'Résultat final' },
        ],
      },
    ],
  },
  {
    ...
    process: [
      ...
      },
      {
        ...
        images: [
          { src: '/assets/image/projects/aftermath-festival/AF_Logo.png', alt: 'Logo Aftermath Festival' },
        ],
      },
      {
        ...
        images: [
          { src: '/assets/image/projects/aftermath-festival/AF_Goodies_Ticket.png', alt: 'Goodies & Tickets' },
          { src: '/assets/image/projects/aftermath-festival/AF_Signe_Prototype_image.png', alt: 'Signalétique — Prototype' },
        ],
      },
      {
        ...
        images: [
          { src: '/assets/image/projects/aftermath-festival/AF_Hompagee.png', alt: 'Page d\'accueil du site' },
        ],
      },
    ],
  },
    ...
    process: [
      {
        ...
        images: [
          { src: '/assets/image/projects/tcgvault/Buisness_model_TCG.png', alt: 'Business Model' },
        ],
      },
      {
        ...
        images: [
          { src: '/assets/image/projects/tcgvault/TCG_Branding.png', alt: 'Branding TCGVault' },
        ],
      },
      {
        ...
        images: [
          { src: '/assets/image/projects/tcgvault/TCG_home_phone.png', alt: 'Page d\'accueil mobile' },
          { src: '/assets/image/projects/tcgvault/TCG_Inventory.png', alt: 'Inventaire de cartes' },
        ],
      },
      {
